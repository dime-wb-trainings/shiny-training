...
You can find the **final solutions** (both single-file and multiple-file apps) in our GitHub repository:
📦 *\[pending]*
...
- 🧪 **Shiny Tutorial** (Official Getting Started Guide)  
  [https://shiny.posit.co/tutorial](https://shiny.posit.co/tutorial)

- 📘 **Mastering Shiny** by Hadley Wickham (Free online book)  
  [https://mastering-shiny.org](https://mastering-shiny.org)

- 💡 **Shiny Widgets Gallery**  
  [https://shiny.posit.co/r/gallery/widgets/widget-gallery/](https://shiny.posit.co/r/gallery/widgets/widget-gallery/)
...
- 🌐 **Shiny Community** (Forums, discussions)
  [https://community.rstudio.com/c/shiny](https://community.rstudio.com/c/shiny)
