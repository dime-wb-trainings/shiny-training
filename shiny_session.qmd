...
📦 *https://github.com/dime-wb-trainings/shiny-training*
...
* `output$distPlot <- renderPlot()`
  ↔ `plotOutput("distPlot")` in the **UI**

* `input$bins`
  ↔ `sliderInput("bins", ...)` in the **UI**
...
### 🏢 On-Premises & VPC Deployment (Most Secure)

- **Posit Connect (Internal / Commercial)**  
  - Recommended option for **secure deployment within the Bank**  
  - Push-button publishing from RStudio  
  - [Learn more](https://posit.co/products/enterprise/connect/)

- **Shiny Server (Open Source)**  
  - Deploy behind a firewall  
  - Ideal for lightweight internal hosting  
  - [More info](https://posit.co/download/shiny-server/)
...
- **Posit Connect Cloud**  
  - Publish from GitHub in under a minute  
  - [Free and paid plans](https://posit.cloud/connect)

- **Shinyapps.io**  
  - Easiest way to publish Shiny apps online  
  - No server setup or installation needed  
  - Secure and scalable, but **not for sensitive data**  
  - [Free and paid plans](https://www.shinyapps.io/)
